  ...
  <div class="expenses-view-page">
    ...
    <div class="container">
      ...
      <div class="page-header">
        <router-link :to="`/finance/project/${projectId}`" class="btn-back">
      ...
      <div class="budget-summary">
        ...
        <div class="summary-card card-executed">
          ...
          <div class="card-body">
            ...
            <div class="card-label">{{ expenses.length }} gastos registrados</div>
          </div>
        </div>
      ...
      <div v-if="executionPercentage >= 90" class="alert alert-danger">
        ...
        <div>
          <strong>⚠️ Presupuesto Crítico</strong>
      ...
      <div v-else-if="executionPercentage >= 70" class="alert alert-warning">
        ...
        <div>
          <strong>🔔 Alerta Presupuestal</strong>
        ...
        <div class="filter-section">
          ...
          <div class="filter-bar">
            ...
            <div class="filter-results">
              ...
              <span class="results-text">gastos encontrados</span>
          ...
          <div class="summary-info">
            ...
            <div>
              ...
              <div class="category-stats">
                {{ filteredExpenses.length }} gastos · {{ formatMoney(filteredTotal) }}
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="expense-body">
              ...
              <div class="expense-footer">
                ...
                <span>Registrado {{ formatDateTime(expense.created_at) }}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  setup() {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        console.log('✅ Proyecto y gastos cargados:', {
          proyecto: project.value.nombre,
          gastos: expenses.value.length,
          total: totalExecuted.value
        })
      } catch (err) {
